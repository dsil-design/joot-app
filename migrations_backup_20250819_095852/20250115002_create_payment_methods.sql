...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'payment_methods' AND policyname = 'Users can view their own payment methods'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'payment_methods' AND policyname = 'Users can insert their own payment methods'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'payment_methods' AND policyname = 'Users can update their own payment methods'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'payment_methods' AND policyname = 'Users can delete their own payment methods'
    ) THEN
...
-- Skip creating trigger if it already exists (from initial schema)
DO $$ 
BEGIN
    IF NOT EXISTS (
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_trigger WHERE tgname = 'create_user_payment_methods'
    ) THEN
