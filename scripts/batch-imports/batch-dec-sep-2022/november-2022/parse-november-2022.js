 ...
 * - Expense Tracker: 9551-9807 (~257 lines)
 * - Gross Income Tracker: 9809-9815 (~7 lines)
 * - Personal Savings & Investments: 9819 (~1 line)
 */

console.log('========================================');
console.log('NOVEMBER 2022 PARSING SCRIPT');
console.log('========================================\n');
...
// Section 1: Expense Tracker (lines 9551-9807)
console.log('Parsing Expense Tracker (lines 9551-9807)...');
let currentDate = null;

for (let i = 9550; i < 9808; i++) {
  ...
  const transaction = {
    transaction_date: currentDate || '2022-11-30',
    description,
    merchant,
    amount,
    currency,
...
// Section 2: Gross Income Tracker (lines 9809-9815)
console.log('Parsing Gross Income Tracker (lines 9809-9815)...');

let incomeDate = '2022-11-30';

for (let i = 9809; i < 9816; i++) {
  const row = parseCSV(lines[i]);
...
// Section 3: Personal Savings & Investments (line 9819)
console.log('Parsing Personal Savings & Investments (line 9819)...');

let savingsDate = '2022-11-30';

for (let i = 9818; i < 9820; i++) {
  const row = parseCSV(lines[i]);
...
// Write output file
const outputPath = path.join(__dirname, 'november-2022-CORRECTED.json');
fs.writeFileSync(outputPath, JSON.stringify(transactions, null, 2));

// Write metadata file
const metadataPath = path.join(__dirname, 'november-2022-METADATA.json');
const metadata = {
  month: 'November 2022',
...
console.log('1. Review november-2022-CORRECTED.json');
