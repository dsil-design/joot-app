 ...
 * - Expense Tracker: 10189-10460 (~257 lines)
 * - Gross Income Tracker: 10463-10470 (~7 lines)
 * - Personal Savings & Investments: 10474 (~1 line)
 */

console.log('========================================');
console.log('SEPTEMBER 2022 PARSING SCRIPT');
console.log('========================================\n');
...
// Section 1: Expense Tracker (lines 10189-10460)
console.log('Parsing Expense Tracker (lines 10189-10460)...');
let currentDate = null;

for (let i = 10188; i < 10461; i++) {
  ...
  const transaction = {
    transaction_date: currentDate || '2022-09-30',
    description,
    merchant,
    amount,
    currency,
...
// Section 2: Gross Income Tracker (lines 10463-10470)
console.log('Parsing Gross Income Tracker (lines 10463-10470)...');

let incomeDate = '2022-09-30';

for (let i = 10462; i < 10471; i++) {
  const row = parseCSV(lines[i]);
...
// Section 3: Personal Savings & Investments (line 10474)
console.log('Parsing Personal Savings & Investments (line 10474)...');

let savingsDate = '2022-09-30';

for (let i = 10473; i < 10475; i++) {
  const row = parseCSV(lines[i]);
...
// Write output file
const outputPath = path.join(__dirname, 'september-2022-CORRECTED.json');
fs.writeFileSync(outputPath, JSON.stringify(transactions, null, 2));

// Write metadata file
const metadataPath = path.join(__dirname, 'september-2022-METADATA.json');
const metadata = {
...
console.log('1. Review september-2022-CORRECTED.json');
