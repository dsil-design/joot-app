...
/**
 * MAY 2021 PARSING SCRIPT
 * Enhanced with 24+ months of historical learnings
 *
 * Protocol: MASTER-IMPORT-PROTOCOL v4.0 + Protocol v2.0
 * Batch: Aug-May 2021 (Month 4 of 4)
 *
 * Line Ranges from CSV:
 * - Expense Tracker: 14152-14382 (~207 lines)
 * - Gross Income Tracker: 14383-14393 (~9 lines)
 * - Personal Savings & Investments: 14395-14398 (~4 lines)
 */

console.log('========================================');
console.log('MAY 2021 PARSING SCRIPT');
console.log('========================================\n');
console.log('Protocol: MASTER-IMPORT-PROTOCOL v4.0');
console.log('Enhanced with 24+ months of historical learnings');
console.log('Batch: Aug-May 2021 (Month 4 of 4)\n');
...
function parseFullDate(dateStr) {
  ...
  if (match) {
    ...
    if (monthName === 'August' && year !== '2021') {
      console.log(`  ⚠️  DATE TYPO DETECTED: ${dateStr} - Expected May 2021`);
      parsedYear = '2021';
...
// Section 1: Expense Tracker (lines 14152-14382)
console.log('Parsing Expense Tracker (lines 14152-14382)...');
let currentDate = null;

for (let i = 14151; i < 14383; i++) {
...
// Section 2: Gross Income Tracker (lines 14383-14393)
console.log('Parsing Gross Income Tracker (lines 14383-14393)...');

// Set default date to last day of month for income without specific dates
let incomeDate = '2021-05-31';

for (let i = 14382; i < 14394; i++) {
  const row = parseCSV(lines[i]);
...
// Section 3: Personal Savings & Investments (lines 14395-14398)
console.log('Parsing Personal Savings & Investments (lines 14395-14398)...');

// Set default date to last day of month for savings
let savingsDate = '2021-05-31';

for (let i = 14394; i < 14399; i++) {
  const row = parseCSV(lines[i]);
...
// Write output file
const outputPath = path.join(__dirname, 'may-2021-CORRECTED.json');
fs.writeFileSync(outputPath, JSON.stringify(transactions, null, 2));

// Write metadata file
const metadataPath = path.join(__dirname, 'may-2021-METADATA.json');
const metadata = {
  month: 'May 2021',
...
console.log('1. Review may-2021-CORRECTED.json');
