...
/**
 * April 2021 Import Script
 * Imports 170 transactions from april-2021-CORRECTED.json
 * Part of Aug-April 2021 Batch Import (Batch 9, Month 1)
 */
...
const JSON_FILE = path.join(__dirname, 'april-2021-CORRECTED.json');
