...
/**
 * January 2021 Import Script
 * Imports 170 transactions from january-2021-CORRECTED.json
 * Part of Aug-January 2021 Batch Import (Batch 9, Month 4)
 */
...
const JSON_FILE = path.join(__dirname, 'january-2021-CORRECTED.json');
