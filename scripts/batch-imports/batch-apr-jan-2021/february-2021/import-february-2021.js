...
/**
 * February 2021 Import Script
 * Imports 170 transactions from february-2021-CORRECTED.json
 * Part of Aug-February 2021 Batch Import (Batch 9, Month 3)
 */
...
const JSON_FILE = path.join(__dirname, 'february-2021-CORRECTED.json');
