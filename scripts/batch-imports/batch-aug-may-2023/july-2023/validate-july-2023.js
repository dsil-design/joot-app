...
console.log('========================================');
console.log('JULY 2023 VALIDATION QUERIES');
...
async function runValidation() {
  ...
  const { count: totalTagCount } = await supabase
    ...
    .gte('transactions.transaction_date', '2023-07-01')
    .lte('transactions.transaction_date', '2023-07-31');
  ...
  console.log(`Expected: 2 (from parsing)\n`);

  const expectedTagCount = 2; // From parsing output
  ...
  console.log(`Expected THB: ~56.3% (from parsing)\n`);

  const expectedThbPercent = 56.3;
