 ...
 * - Expense Tracker: 12709-12882 (~209 lines)
 * - Gross Income Tracker: 12883-12891 (~10 lines)
 * - Personal Savings & Investments: 12893-12895 (~3 lines)
 */

console.log('========================================');
console.log('NOVEMBER 2021 PARSING SCRIPT');
console.log('========================================\n');
...
function parseFullDate(dateStr) {
  ...
  if (match) {
    ...
    if (monthName === 'December' && year !== '2021') {
      console.log(`  ⚠️  DATE TYPO DETECTED: ${dateStr} - Expected November 2021`);
      parsedYear = '2021';
...
// Section 1: Expense Tracker (lines 12709-12882)
console.log('Parsing Expense Tracker (lines 12709-12882)...');
let currentDate = null;

for (let i = 12708; i < 12883; i++) {
  ...
  const transaction = {
    transaction_date: currentDate || '2021-11-30',
    description,
    merchant,
    amount,
    currency,
...
// Section 2: Gross Income Tracker (lines 12883-12891)
console.log('Parsing Gross Income Tracker (lines 12883-12891)...');

// Set default date to last day of month for income without specific dates
let incomeDate = '2021-11-30';

for (let i = 12883; i < 12893; i++) {
  const row = parseCSV(lines[i]);
...
// Section 3: Personal Savings & Investments (lines 12893-12895)
console.log('Parsing Personal Savings & Investments (lines 12893-12895)...');

// Set default date to last day of month for savings
let savingsDate = '2021-11-30';

for (let i = 12893; i < 12896; i++) {
  const row = parseCSV(lines[i]);
...
// Write output file
const outputPath = path.join(__dirname, 'november-2021-CORRECTED.json');
fs.writeFileSync(outputPath, JSON.stringify(transactions, null, 2));

// Write metadata file
const metadataPath = path.join(__dirname, 'november-2021-METADATA.json');
const metadata = {
  month: 'November 2021',
...
console.log('1. Review november-2021-CORRECTED.json');
