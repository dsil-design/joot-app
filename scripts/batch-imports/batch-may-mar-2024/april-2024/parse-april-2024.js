...
console.log('========================================');
console.log('APRIL 2024 PARSING SCRIPT');
console.log('========================================\n');
console.log('Protocol: BATCH-IMPORT-PROTOCOL-v1.1 + Monthly v3.6');
console.log('Batch: May-Apr-Mar 2024 (Month 2 of 3 - MOST RECENT)\n');
console.log('Key Features:');
console.log('- NO VND column (standard THB/USD only)');
console.log('- 6 negative amounts (Krabi trip reimb)');
console.log('- Column 4 for Business Expense (ignore Column 3)');
console.log('- No Florida House section\n');

// Section 1: Expense Tracker (lines 5245-5494)
console.log('Parsing Expense Tracker (lines 5245-5494)...');
let currentDate = null;

for (let i = 5244; i < 5495; i++) {
  ...
  // April 2024: Standard columns (NO VND)
  ...
  // Skip zero-dollar transactions (v1.1 policy)
...
// Section 2: Gross Income Tracker (lines 5495-5499)
console.log('Parsing Gross Income Tracker (lines 5495-5499)...');

// Set default date to last day of month for income without specific dates
let incomeDate = '2024-04-30';

for (let i = 5494; i < 5500; i++) {
  const row = parseCSV(lines[i]);
...
// Section 3: Personal Savings & Investments (lines 5501-5504)
console.log('Parsing Personal Savings & Investments (lines 5501-5504)...');

// Set default date to last day of month for savings
let savingsDate = '2024-04-30';

for (let i = 5500; i < 5505; i++) {
  const row = parseCSV(lines[i]);
...
// Section 4: Florida House Expenses - NOT PRESENT IN APRIL 2024
console.log('Florida House Expenses: NOT PRESENT (no section in April 2024)\n');
...
console.log(`✅ Reimbursement tag count: ${reimbursementCount} (Expected: 5)`);
...
// Write output file
const outputPath = path.join(__dirname, 'april-2024-CORRECTED.json');
...
console.log('1. Review april-2024-CORRECTED.json');
console.log('2. Verify rent = THB 25,000 (not USD)');
console.log('3. Verify all negative amounts converted');
