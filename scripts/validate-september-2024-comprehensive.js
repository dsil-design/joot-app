...
async function queryDatabase() {
  ...
  console.log('Querying September 2024 transactions from database...\n');
  ...
  const savingsInvestment = transactions.filter(t => t.tags && t.tags.includes('Savings/Investment'));
  ...
  transactions.forEach(t => {
    ...
    if (t.transaction_type === 'income') {
      ...
      // Expense
      if (t.tags && t.tags.includes('Florida House')) {
        floridaHouseTotal += usdAmount;
      } else if (t.tags && t.tags.includes('Savings/Investment')) {
