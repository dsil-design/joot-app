...
function AlertDialogContent({
  ...
  return (
    <AlertDialogPortal>
      <AlertDialogOverlay />
      {/*
        iOS WebKit mis-hit-tests native text-selection handles when the
        target lives inside `position: fixed` + `transform: translate(-50%, -50%)`.
        Centering happens on this non-transformed wrapper instead, so selection
        handles inside any future alert-dialog inputs stay draggable on iPad/iPhone.
      */}
